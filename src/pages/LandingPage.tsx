...
const PACKAGES_INFO = [
    { icon: '🎓', name: 'ব্যাচ ২০১৮–২০২৫', price: '৳৭০০', desc: '১ জন · ডিনার + সম্পূর্ণ অনুষ্ঠান', color: '#5b52e8', popular: true },
    { icon: '🏫', name: 'ব্যাচ ১৯৪৫–২০১৭', price: '৳১,০০০', desc: '১ জন · ডিনার + সম্পূর্ণ অনুষ্ঠান', color: '#E2136E' },
